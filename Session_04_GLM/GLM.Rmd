...
See `code/ordered.R` for a practical example of the ordered logistic regression. There we analyze how religion (yes/no), gender, college degree (yes/no) and country of residence (USA/Sweden) influence people's beliefs whether their country does enough to fight poverty.
