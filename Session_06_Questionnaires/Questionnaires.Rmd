...
If cognitive demands/load on respondents are minimised and mental capacity is freed up in order to think about a response, the quality of the data obtained is likely to improve.

###### Question length

Keep questions as short as possible. Research for the English language suggests a maximum of 15-20 words. On the other hand, some research shows that it increases data quality if a question or group of questions is preceeded by a medium-length introduction (15-60 words).

###### Grammar and vocabulary

In general, we should keep gramatical complexity at a minimum: active over passive, repeat nouns instead of pronouns (you, he, she, it, we, they), avoid negations.
...
- Annonimity or at least confidentiality of the study might increase response rates. Of course, respondents must be made aware of this in the frontmatter.
