...
To get a positive grade, you need to gather at least 50\% of all available points from homework. Your submission that receives the worst grade will be discarded when calculating the final homework grade. Meaning that you can skip one homework without any major repercussions. To finish the course you need to take an oral exam at the end of the semester. Only students that gathered at least 50\% of points from the homework are allowed to take the exam. The oral exam will be used to test your knowledge both in the theoretical and in the practical aspects of Bayesian statistics that we covered during lectures.
