...
Since lectures are already very practically oriented, the lab practice is slightly different than in most other courses. The lab practice slot will be mainly used for clarifications of any concepts that were not completely understood from lecture alones as well as for consultations and assistance regarding your homework. During the lab practice slot, course lecturer will be present in the designated lecture room and you can come and pick his brain about anything Bayesian statistics related (or not). You can also use the lab practice slot to work on your homework assignemts and discuss them with your colleagues and the lecturer.
