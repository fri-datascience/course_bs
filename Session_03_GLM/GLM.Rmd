...
Let us start our venture into GLMs by building on our previous attempt of modeling relationship between person's height and gender. In our case gender is a binary variable so it would make sense to use a suitable pdf. Bernoulli's distribution was a good fit when we modeled coin tosses so let us try building a linear model with it:
