...
$$y_t \; | \; \alpha, \beta_1, \beta_2, \sigma \sim N \left( \alpha + \beta_1 y_{t-2} + \beta_2 y_{t-4}, \sigma \right).$$
...
$$y_t \; | \; \alpha, \beta, p, \theta, s, \sigma \sim N \left( \alpha + \sum_{i=1}^p \beta_i y_{t-i} + \sum_{j=1}^s \theta_j x_{t-j}, \sigma \right),$$
