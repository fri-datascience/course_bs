...
# in order to discard 10% of data we need to use a pair from our bound vectors
...
ggplot(data = df) +
  ...
  xlab("difference") +
  geom_vline(xintercept = q5, linetype="dashed", color = "grey80", size=1) +
  geom_vline(xintercept = q95, linetype="dashed", color = "grey80", size=1) +
  geom_vline(xintercept = result[1], color = "grey40", size=1) +
  geom_vline(xintercept = result[2], color = "grey40", size=1)
