...
$$y \; | \; p, x, \beta, \sigma \sim N(\sum_{i=0}^{p}{\beta_i x^i}, \sigma),$$
...
$$y \; | \; x_1, x_2 \sim N(1 + 1.5x_1 - 2.5x_2, 1).$$

We will fit multiple linear regression models of varying complexity to our toy data:

$$y \; | \; m, x, \alpha, \beta, \sigma \sim N \left(\alpha + \sum_{i=1}^m \beta_i x_i, \sigma \right),$$
