...
set.seed(0)
model1 <- cmdstan_model("./simple.Stan")
...
```{r comment='', echo = F}
cat(readLines("./stratified.Stan"), sep = '\n')
```

```{r echo=FALSE, warning=FALSE, message=FALSE, results = 'hide'}
model2 <- cmdstan_model("./stratified.Stan")
...
```{r comment='', echo = F}
cat(readLines("./clustered.Stan"), sep = '\n')
```
...
model3 <- cmdstan_model("./clustered.Stan")
