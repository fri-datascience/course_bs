...
$$y \; | \; x, \beta, \sigma \sim N(\sum_{i=1}^{p}{\beta_i x^{i-1}}, \sigma),$$
...
You can also think of the information entropy as the potential surprise. If entropy is low the potential of surprise is higher. For example, we are not often surprised by wehater in Los Angeles as it is almost always sunny, we are much more often surprised by rain in Ljubljana.
