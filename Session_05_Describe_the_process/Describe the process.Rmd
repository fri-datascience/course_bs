...
The fitting process executed without any issues and the diagnostics look fine, so we can continue with our analysis. The $\sigma$ parameters equals 0.22 $\pm$ 0.8 $\cdot$ 10^-5^ in radians and in 1.23 $\pm$ 0.0005 in degrees. Meaning that the standard deviation of golf putting angular errors in pro golfers is just above a degree. Which is mightily impressive.
