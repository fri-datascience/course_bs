...
The fitting process executed without any issues and the diagnostics look fine, so we can continue with our analysis. The $\sigma$ parameters equals 0.22 $\pm$ 8 $\cdot$ 10^-6^ in radians and 1.23 $\pm$ 5 $\cdot$ 10^-5^ in degrees. Meaning that the standard deviation of golf putting angular errors in pro golfers is just above a degree. Which is very impressive.
